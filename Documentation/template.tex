...
\Large\hspace{1.5in}NAME \hfill ~\\[0.05in] % First line of institution name, adjust hspace if your logo is wide
\hspace{1.5in}NAME \hfill \normalsize % Second line of institution name, adjust hspace if your logo is wide
...
\hspace{\fill}\parbox[t]{2.75in}{ % Create a box for your details underneath the horizontal rule on the right
...
\hspace*{10mm} % Move the signature right
